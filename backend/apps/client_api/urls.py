...
urlpatterns = [
    ...
    path('auth/password/olvide/', OlvideMiClaveView.as_view(), name='client-olvide-clave'),
    path('auth/password/restablecer/', RestablecerClaveView.as_view(), name='client-restablecer-clave'),
